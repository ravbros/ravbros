...
def draw():
    if not börjat:
        ...
        screen.draw.text("Rävbros: 2 player edition ",topleft=(200,100),fontsize=60)
        ...
        screen.fill("red")
        screen.draw.text("Slutsumma:"+str(summa), color="black", topleft=(200,250), fontsize=60)
    else:
        screen.blit("p",(0,0))
        rav.draw()
        ravio.draw()
...
sounds.start.play()
rav.pos=400,250
clock.schedule_interval(flytta_igelkott,1)
